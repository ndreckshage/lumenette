  ...
  render() {
    ...
    return (
      <AssetOverview
        ...
        source={require('app/assets/animated-logo-ltc.json')}
...
const mapStateToProps = state => ({
  ...
  zeroBalance: selectors.selectLitecoinZeroBalance(state),
  bitcoinBalance: selectors.selectLitecoinDisplayBalance(state),
  lumenFiatBalance: selectors.selectLitecoinFiatDisplayBalance(state)
});

export default connect(mapStateToProps)(LitecoinOverview);
