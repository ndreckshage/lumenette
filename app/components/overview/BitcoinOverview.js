  ...
  render() {
    ...
    return (
      <AssetOverview
        ...
        source={require('app/assets/animated-logo-btc.json')}
...
const mapStateToProps = state => ({
  ...
  zeroBalance: selectors.selectBitcoinZeroBalance(state),
  bitcoinBalance: selectors.selectBitcoinDisplayBalance(state),
  lumenFiatBalance: selectors.selectBitcoinFiatDisplayBalance(state)
});

export default connect(mapStateToProps)(BitcoinOverview);
